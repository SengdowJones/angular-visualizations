...
export class DoughnutChartSelectionSampleComponent implements AfterViewInit {
  ...
  constructor() {
    this.data = [
      { Value: 37, Label: 'Analytical', Summary: 'Analytical 37%' },
      { Value: 25, Label: 'Authenticity', Summary: 'Authenticity 25%' },
      { Value: 12, Label: 'Certainty', Summary: 'Certainty 12%' },
      { Value: 11, Label: 'Clout', Summary: 'Clout 11%' },
      { Value: 18, Label: 'Emotional', Summary: 'Emotional 18%' },
    ];
  }
